...
param(
    ...
    [string]$Repository = 'open-cli-collective/hubspot-cli'
)

$nuspec = Join-Path $PackageDirectory 'hubspot-cli.nuspec'
...
$values = [ordered]@{
    URL_AMD64_PLACEHOLDER      = "$baseUrl/hspt_${Version}_windows_amd64.zip"
    URL_ARM64_PLACEHOLDER      = "$baseUrl/hspt_${Version}_windows_arm64.zip"
