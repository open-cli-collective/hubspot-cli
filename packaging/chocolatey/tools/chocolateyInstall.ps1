...
if ($env:PROCESSOR_ARCHITECTURE -eq 'ARM64') {
    ...
    throw "32-bit Windows is not supported. hspt requires 64-bit Windows."
}

$baseUrl = "https://github.com/open-cli-collective/hubspot-cli/releases/download/v${version}"
$zipFile = "hspt_${version}_windows_${arch}.zip"
$url = "${baseUrl}/${zipFile}"

Write-Host "Installing hspt ${version} for Windows ${arch}..."
Write-Host "URL: ${url}"
...
Write-Host "hubspot-cli installed successfully. Run 'hspt --help' to get started."
